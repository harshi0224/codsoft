...
result_lable = Label(root, text="Generated Password : ", bg="skyblue", fg="darkgreen", font=("ubuntu", 12))
result_lable.place(x="20px", y="160px")

password = StringVar()
password_final = Entry(root, textvariable= password, state="readonly", fg="black", font=("ubuntu", 15))
password_final.place(x="145px", y="160px")
